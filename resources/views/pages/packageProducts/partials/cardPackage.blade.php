            ...
            <div class="row mb-4 mt-4">
                @if( $percent_markup > 0 )
                    <div class="col-6">
                        ...
                        <div class="text-tertiary text-weight-400 fs-16" style="color: rgba(16, 16, 16, 0.4); text-decoration: line-through;">Rp. {{ number_format($price + ( $price * $percent_markup )) }}</div>
                    </div>
                @endif
