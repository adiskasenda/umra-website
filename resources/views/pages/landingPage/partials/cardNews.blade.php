<a href="{{ $url }}">
    <div class="card card-bordered" style="width: 100%; height: 100%;">
        <div class="card-body" style="padding: 1rem !important;">
            <img class="img-card" src="{{ $url_banner == 'https://api-uploads.umra.id/banner/bbf39ed3-e959-470e-a256-d80295b146e0.jpeg' ? asset('/assets-web/img/artikle-default.jpg') : $url_banner }}" width="100%" alt="{{ $url_banner }}">
