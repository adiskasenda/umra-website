<a href="{{ $url }}">
    <div class="card card-bordered" style="width: 100%; height: 100%;">
        <div class="card-body" style="padding: 1rem !important;">
            ...
            <div class="h-artikle" style="border-radius: 8px; background-image: url('{{ $url_banner == 'https://api-uploads.umra.id/banner/bbf39ed3-e959-470e-a256-d80295b146e0.jpeg' ? Helpers::imageArtikelDefault() : $url_banner }}'); background-size: cover; background-repeat: no-repeat; background-position: center center;"></div>
