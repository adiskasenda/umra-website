! function() {
    ...
    t.jqPaginator = function(e, a) {
        ...
        wrapper: "",
        prev: '<li class="page-item previous"><a href="javascript:void(link({{page}}));" class="page-link"><i class="previous"></i></a></li>',
        next: '<li class="page-item next"><a href="javascript:void(link({{page}}));" class="page-link"><i class="next"></i></a></li>',
        page: '<li class="page-item"><a href="javascript:void(link({{page}}));"  class="page-link">{{page}}</a></li>',
        totalPages: 0,
        totalCounts: 0,
        pageSize: 0,
        currentPage: 1,
