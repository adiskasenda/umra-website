    ...
    return function() {
        function e(e, t) {
            var s = t.count,
                ...
                n = t.previewDuration,
                c = void 0 === n ? 200 : n;
            this.args = t, this.selector = document.querySelector(e), this.count = i, this.secure = o, this.previewDuration = c, this.cells = [], this.focusedCellIdx = 0, this.value = "", this.setCells()
        }
        return e.prototype.setCells = function() {
            ...
            this.cells[e].classList.add("pincode-input--filled"), this.secure && this.previewDuration && setTimeout((function() {
                i.cells[e].setAttribute("type", "password")
